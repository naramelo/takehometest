...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Username_loginusername'), 'ahzkanabila')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_STORE/input_Password_loginpassword'), 'H0hgV2sdA/8KSzQbQ0kMXw==')
...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Name_name'), 'buyingTest')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Country_country'), 'Indonesia')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_City_city'), 'Bekasi')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Credit card_card'), '12333')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Month_month'), '12')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Year_year'), '2002')
