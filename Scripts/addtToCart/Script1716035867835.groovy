...
WebUI.click(findTestObject('Object Repository/Page_STORE/img_Cart_d-block img-fluid'))
...
WebUI.sendKeys(findTestObject('Object Repository/Page_STORE/input_Password_loginpassword'), Keys.chord(Keys.ENTER))
